...
void solo_awp_right() {
    chassis.moveToPoint(0, 23.5, 1000, {.minSpeed = 10, .earlyExitRange = 1});
    ...
    pros::delay(200);
    chassis.moveToPoint(-21, 23.3, 1500, {.forwards = false}); // backwards
    chassis.waitUntil(22);
    set_intakeb(12000);
    // score
    pros::delay(700);
    chassis.moveToPoint(-11, 23.3, 1000, {.minSpeed = 10, .earlyExitRange = 2});

    toggle_matchload();

    chassis.turnToHeading(208, 1000, {.minSpeed = 1, .earlyExitRange = 5});
    set_both(0);
    chassis.moveToPoint(-22, 8, 1500);
    set_intakef(12000);
    chassis.waitUntil(14);
    toggle_matchload();
    chassis.turnToHeading(185, 1000, {.minSpeed = 1, .earlyExitRange = 5});

    chassis.moveToPoint(-23, -31, 1500);
    chassis.waitUntil(1);
    toggle_matchload();
    ...
    chassis.moveToPoint(-37, -18.5, 1200, {.forwards = false, .maxSpeed = 70, .minSpeed = 50});
    chassis.waitUntil(5);
    set_intakef(-12000);
    pros::delay(50);
    set_intakef(12000);
    ...
    chassis.moveToPoint(-3, -51.5, 2000, {.minSpeed = 10, .earlyExitRange = 2});
    chassis.turnToHeading(90, 1000, {.minSpeed = 10, .earlyExitRange = 5});
    chassis.moveToPoint(12, -51, 1000);
    pros::delay(500);
    chassis.moveToPoint(-19, -51, 1000, {.forwards = false});
    chassis.waitUntilDone();
    set_both(12000);
}
...
void ball7_right() {
    ...
    chassis.waitUntilDone();
    chassis.turnToHeading(180, 1000, {.maxSpeed = 60, .minSpeed = 30, .earlyExitRange = 1});
    chassis.waitUntilDone();
    chassis.moveToPose(34, -36, 180.0, 1800, {.forwards = false, .lead = 0.1, .maxSpeed = 80, .minSpeed = 60});
    ...
    // chassis.moveToPose(chassis.getPose().x - 10, chassis.getPose().y - 9, 220, 1000,
    //                    {.lead = .1, .maxSpeed = 80, .minSpeed = 50, .earlyExitRange = 2});
    // toggle_matchload();
    // chassis.moveToPose(33, -25, 180, 2000, {.forwards = false, .maxSpeed = 90, .minSpeed = 60, .earlyExitRange = 2});
    // chassis.setBrakeMode(pros::motor_brake_mode_e::E_MOTOR_BRAKE_HOLD);
    // chassis.waitUntilDone();
...
void skills_auto() {
    ...
    chassis.waitUntil(5);
    set_intakef(12000);
    chassis.moveToPoint(-23.5, -29, 1500, {.maxSpeed = 70});
    chassis.waitUntil(5);
    set_intakef(0);
    chassis.turnToHeading(-135, 1000);
    chassis.moveToPose(-5.5, -15.5, -135, 4000, {.forwards = false, .maxSpeed = 90, .minSpeed = 75});
    ...
    set_intakeb(0);
    pros::delay(600);
    chassis.moveToPose(-42.5, -52, 180, 1000, {.forwards = false, .maxSpeed = 60, .minSpeed = 30});
    chassis.waitUntilDone();
    pros::delay(100);
    resetcoord(3, 180);
    pros::delay(100);
    ...
    chassis.turnToHeading(-90, 1000, {.minSpeed = 10, .earlyExitRange = 2});
    chassis.moveToPoint(-45, 18, 1000, {.forwards = false, .maxSpeed = 100, .minSpeed = 20, .earlyExitRange = 1});
    chassis.turnToHeading(0, 1000, {.minSpeed = 10, .earlyExitRange = 2});
    chassis.moveToPoint(-45, 1.5, 1700, {.forwards = false, .maxSpeed = 110});
    chassis.waitUntil(5);
    set_both(-12000);
    pros::delay(50);
    set_both(12000);
    pros::delay(2000);
    chassis.moveToPoint(-45, 40, 3000, {.maxSpeed = 65});
    toggle_matchload();
    set_intakeb(0);
    chassis.waitUntilDone();
    pros::delay(100);
    chassis.moveToPoint(-45, 5, 2000, {.forwards = false, .maxSpeed = 100});
    chassis.waitUntil(21);
    set_both(12000);
    toggle_matchload();
    pros::delay(1000);
    set_intakeb(8000);
    pros::delay(500);
    chassis.moveToPose(-45, 20, 0, 1000, {.maxSpeed = 100, .minSpeed = 10});
    chassis.waitUntilDone();
    resetcoord(2, 0);
    pros::delay(50);
    // //-47, 41

    chassis.moveToPose(-20, 59, 90, 1500, {.lead = .27, .maxSpeed = 100});
    chassis.waitUntilDone();
    toggle_matchload();
    chassis.moveToPose(28, 59, 90, 6000, {.maxSpeed = 70});
    chassis.waitUntil(13);
    toggle_matchload();
    set_intakeb(0);
    set_intakef(12000);
    ...
    chassis.moveToPoint(21, 23.5, 1000);
    chassis.waitUntil(6);
    set_intakef(0);
    chassis.turnToHeading(45, 1000);
    chassis.moveToPose(10, 13.5, 45, 2300,  {.forwards = false, .maxSpeed = 50, .minSpeed = 45});
    chassis.waitUntil(8);
    ...
    chassis.turnToHeading(0, 1000, {.minSpeed = 10, .earlyExitRange = 2});
    toggle_matchload();
    chassis.moveToPoint(45.5, 67, 3200, {.maxSpeed = 60, .minSpeed = 20});
    set_intakef(12000);
    set_intakeb(0);
    ...
    set_both(0);
    chassis.moveToPoint(55, -18, 4000, {.forwards = false, .maxSpeed = 90, .minSpeed = 30, .earlyExitRange =1 });
    ...
    chassis.moveToPoint(53, -36, 1000, {.forwards = false, .maxSpeed = 100, .minSpeed = 20, .earlyExitRange = 1});
    chassis.turnToHeading(180, 1000, {.minSpeed = 10, .earlyExitRange = 2});
    chassis.moveToPoint(52.5, -22, 2000, {.forwards = false, .maxSpeed = 70});
    chassis.waitUntil(4);
    set_both(12000);
    pros::delay(2000);
    ...
    toggle_matchload();
    set_intakeb(0);
    chassis.moveToPoint(52.5, -57, 2500, {.maxSpeed = 55});
    pros::delay(3000);
    chassis.moveToPoint(52.5, -22, 2000, {.forwards = false, .maxSpeed = 70});
    chassis.waitUntil(20);
    set_both(12000);
    pros::delay(2800);
    toggle_matchload();
    chassis.moveToPose(52.5,-35, 180, 1000, {.maxSpeed = 70});
    resetcoord(4, 180);
