...
void skills_auto() {
    ...
    chassis.moveToPose(-5.5, -14.5, -135, 4000, {.forwards = false, .maxSpeed = 70, .minSpeed = 50});
    ...
    set_both(12000);
    pros::delay(2500);
    chassis.moveToPoint(-43.7, 40, 3000, {.maxSpeed = 55});
    toggle_matchload();
    set_intakeb(0);
    chassis.waitUntilDone();
    chassis.moveToPoint(-43.7, 5, 2000, {.forwards = false, .maxSpeed = 100});
    chassis.waitUntil(21);
    set_both(12000);
    toggle_matchload();
    pros::delay(1000);
    set_intakeb(12000);
    pros::delay(500);
    chassis.moveToPose(-43.7, 22, 0, 1000, {.maxSpeed = 100});
    ...
    chassis.moveToPose(-19, 61, 90, 1500, {.lead = .33, .maxSpeed = 100});
    chassis.waitUntilDone();
    toggle_matchload();
    chassis.moveToPose(26, 61, 90, 4000, {.maxSpeed = 100});
    chassis.waitUntil(13);
    toggle_matchload();
    set_intakeb(0);
    set_intakef(12000);
    ...
    chassis.moveToPose(10, 15.5, 45, 1500,  {.forwards = false, .maxSpeed = 60, .minSpeed = 50});
    chassis.waitUntil(10);
    chassis.setBrakeMode(pros::E_MOTOR_BRAKE_BRAKE);
    set_both(-12000);
    pros::delay(150);
    ...
    chassis.moveToPoint(56, 44, 1000, {.forwards = false, .minSpeed = 30, .earlyExitRange = 3});
    chassis.waitUntil(10);
    toggle_matchload();
    ...
    chassis.moveToPoint(51, -36, 1000, {.forwards = false, .maxSpeed = 100, .minSpeed = 20, .earlyExitRange = 1});
    chassis.turnToHeading(180, 1000, {.minSpeed = 10, .earlyExitRange = 2});
    ...
    toggle_matchload();
    set_intakeb(0);
    chassis.moveToPoint(51, -57, 3000, {.maxSpeed = 55});
    chassis.waitUntilDone();
    ...
    pros::delay(2800);
    toggle_matchload();
    chassis.moveToPose(51,-40, 180, 1000, {.maxSpeed = 70});
    chassis.waitUntilDone();
    resetcoord(4, 180);
