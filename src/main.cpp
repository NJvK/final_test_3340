...
void ball7_right() {
    ...
    chassis.moveToPose(39.5, -56, 180, 1400, {.lead = .3, .maxSpeed = 80, .minSpeed = 30});
    exit_condition({40, -56, 130}, 1);
    ...
    chassis.waitUntilDone();
    chassis.moveToPose(38, -30, 180.0, 1800, {.forwards = false, .lead = 0.1, .maxSpeed = 80, .minSpeed = 60});
